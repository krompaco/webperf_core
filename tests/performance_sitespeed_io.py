...
def validate_on_mobile_using_validator(url, validator_config):
    ...
    arg = '--shm-size=1g -b chrome --mobile true --chrome.CPUThrottlingRate 3 --connectivity.profile 3gfast --visualMetrics false --plugins.remove screenshot --speedIndex false --xvfb --browsertime.videoParams.createFilmstrip false --browsertime.chrome.args ignore-certificate-errors -n {0} --preScript chrome-custom.cjs {1}{2}'.format(
...
def validate_on_desktop_using_validator(url, validator_config):
    ...
    arg = '--shm-size=1g -b chrome --connectivity.profile native --visualMetrics false --plugins.remove screenshot --speedIndex false --xvfb --browsertime.videoParams.createFilmstrip false --browsertime.chrome.args ignore-certificate-errors -n {0} --preScript chrome-custom.cjs {1}{2}'.format(
        config.sitespeed_iterations, url, browertime_plugin_options)
    if 'nt' in os.name:
...
def validate_on_desktop(url):
    arg = '--shm-size=1g -b chrome --connectivity.profile native --visualMetrics false --plugins.remove screenshot --speedIndex false --xvfb --browsertime.videoParams.createFilmstrip false --browsertime.chrome.args ignore-certificate-errors -n {0} {1}'.format(
...
def validate_on_mobile(url):
    arg = '--shm-size=1g -b chrome --mobile true --connectivity.profile 3gfast --visualMetrics false --plugins.remove screenshot --speedIndex false --xvfb --browsertime.videoParams.createFilmstrip false --browsertime.chrome.args ignore-certificate-errors -n {0} {1}'.format(
        config.sitespeed_iterations, url)
    if 'nt' in os.name:
